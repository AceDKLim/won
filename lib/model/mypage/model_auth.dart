...
class FirebaseAuthProvider with ChangeNotifier {
  ...
  Future<AuthStatus> registerWithEmail(String email, String pw) async {
    try {
  ...
  Future<void> changePW(String newpw) async {
    await authClient.currentUser?.updatePassword(newpw);
  }
